    ...
    const roleFields = {
        organizer: `
            <div class="input-group">
                ...
                <input type="text" placeholder="Abdulrahman Alghanmi" required>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="email" class="signup-email" placeholder="name@company.com" required>
        ...
        vendor: `
            ...
            <div class="input-group">
                ...
                <select style="width: 100%; padding: 0.8rem 1rem; border: 1px solid var(--border-color); border-radius: var(--radius-sm); font-size: 1rem; background: transparent;">
        ...
        attendee: `
            <div class="form-row">
                <div class="input-group">
                    ...
                    <input type="text" placeholder="Abdulrahman" required>
                </div>
                <div class="input-group">
                    <label>Last Name</label>
                    <input type="text" placeholder="Alghanmi" required>
                </div>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                <label>Email Address</label>
                <input type="email" class="signup-email" placeholder="abdulrahman@example.com" required>
                <div class="error-message email-error">Please enter a valid email address</div>
            </div>
            <div class="input-group">
                <label>Phone Number</label>
